...
If you see this error after signing in with Google, **Supabase is redirecting to localhost** instead of your production pricing page.
...
After saving, try the checkout flow again. You should land on the production pricing page after sign-in, not localhost.
